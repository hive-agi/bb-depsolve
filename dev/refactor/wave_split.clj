(ns refactor.wave-split
  "Split spec for bb-depsolve.wave (509 LOC) — plan-20260724-depsolve-srp
   step 16.

   The audit the step called for found no dead code: bb-depsolve.exec
...
(def owner
  '{bump-wave-cmd "bb-depsolve.wave"
    push-all-cmd "bb-depsolve.wave"
    release-wave-cmd "bb-depsolve.wave"
...
(def spec
  {:base-ns "bb-depsolve.wave"
   ...
   :module-doc
   {"bb-depsolve.wave" "Workspace-wide release orchestration: bump-wave, push-all, release-wave."
